...
public class SampleTankDrive extends TankDrive {
    ...
    public SampleTankDrive(HardwareMap hardwareMap) {
        ...
        DcMotorEx leftRear = hardwareMap.get(DcMotorEx.class, "rearLeft");
        DcMotorEx rightRear = hardwareMap.get(DcMotorEx.class, "rearRight");
        DcMotorEx rightFront = hardwareMap.get(DcMotorEx.class, "frontRear");
